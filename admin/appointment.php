...
<head>
    ...
    <style>
        * {
        ...
        .input-text, .filter-container-items, .header-searchbar {
            border: 2px solid rgba(102, 126, 234, 0.2) !important;
        ...
        .input-text::placeholder, .filter-container-items::placeholder, .header-searchbar::placeholder {
            color: #999 !important;
            opacity: 1 !important;
        }
        
        .input-text:focus, .filter-container-items:focus, .header-searchbar:focus {
