...
<body>
    ...
    <script>
        ...
        // ✅ تحديث Badge رسائل الدردشة (Dashboard)
        ...
        function loadMessages() {
            console.log("🔄 Loading messages for doctor:", docid);
        ...
        `;
            ...
            fetch(`get_doctor_messages.php?docid=${docid}`)
                .then(response => {
