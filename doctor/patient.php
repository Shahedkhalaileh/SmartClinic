    ...
    <div class="container">
        <div class="menu" id="sidebarMenu">
            <table class="menu-container" border="0">
                ...
                <tr class="menu-row">
                    <td class="menu-btn menu-icon-patient menu-active menu-icon-patient-active"><a href="patient.php"
                ...
                <tr class="menu-row">
                    <td class="menu-btn menu-icon-patient"><a href="medical_record.php" class="non-style-link-menu">
                            <div>
                                <p class="menu-text"><?php echo t('medical_record_for_patient'); ?></p>
                            </div>
                        </a></td>
                </tr>
                <tr class="menu-row">
                ...
                <tr>
                    <td width="13%">
                        <a href="index.php"><button class="login-btn btn-primary-soft btn btn-icon-back"
                                style="padding:11px;margin-left:20px;width:125px"><?php echo t('back'); ?></button></a>
                    </td>
                    <td>
                        <form action="" method="post" class="header-search">
                            ...
                            <input type="Submit" value="<?php echo t('search'); ?>" name="search"
                                class="login-btn btn-primary btn" style="padding:10px 25px;">
                        </form>
                    </td>
                    <td width="15%">
                        <p
                            style="font-size:14px;color:rgb(119,119,119);text-align:<?php echo isArabic() ? 'left' : 'right'; ?>;">
                            <?php echo t('todays_date'); ?>
                        </p>
                        <p class="heading-sub12"><?php date_default_timezone_set('Asia/Amman');
                        echo date('Y-m-d'); ?>
                        </p>
                    </td>
                    <td width="10%">
                        ...
                        <center>
                            <table class="filter-container" border="0">
                                <form action="" method="post">
                                    <td style="text-align:<?php echo isArabic() ? 'left' : 'right'; ?>;">
                                        <?php echo t('show_details_about'); ?> &nbsp;
                                    </td>
                                    <td width="30%">
                                    ...
                                    <td width="12%">
                                        <input type="submit" name="filter"
                                            value="<?php echo ' ' . t('filter_button'); ?>"
