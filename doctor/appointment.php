            ...
            <tr>
                ...
                <td>
                    <p style="font-size: 23px;padding-left:12px;font-weight: 600;">
                        <?php echo t('appointment_manager'); ?>
                    </p>
            ...
            <tr>
                <td colspan="4" style="padding-top:10px;width: 100%;">
                    ...
                    <p class="heading-main12" style="margin-left: 45px;font-size:18px;color:rgb(49, 49, 49)">
                        <?php echo t('my_appointments'); ?> (<?php echo $list110->num_rows; ?>)
                    </p>
                </td>
        ...
        function updateAdminMessages() {
            fetch(`get_admin_messages_count.php?docid=${docid}`)
                ...
                .then(data => {
                    ...
                    if (data.status === "ok" && data.admin_unread > 0) {
                        settingsBadge.textContent = data.admin_unread;
